...
using System.IO;
using Multiplica.Examen.Dev.DataBase.Convention;
...
namespace Multiplica.Examen.Dev.DataBase
{
    ...
    ///     The following implementations are provided: <see cref="T:Multiplica.Examen.Dev.DataBase.SqliteCreateDatabaseIfNotExists`1" />,
    ///     <see cref="T:Multiplica.Examen.Dev.DataBase.SqliteDropCreateDatabaseAlways`1" />.
    /// </summary>
